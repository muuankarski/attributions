...
map$group_analysis <- factor(map$group_analysis, levels=c("Western Europe",
                                                             "CEE",
                                                             "CIS",
                                                             NA))
...
pdf("figure/mapplot.pdf", width=14/2.54, height=10/2.54)
mapplot
dev.off()

ppi <- 300
png("figure/mapplot.png", width=14/2.54*ppi, height=10/2.54*ppi, res=ppi)
mapplot
dev.off()
