...
library(knitr)
knit2html('finalPlots.Rmd', options = c('toc', markdown::markdownHTMLOptions(TRUE)))
...
png("figure/scatter_giniSB.png", width=12/2.54*ppi, height=8/2.54*ppi, res=ppi)
plot1
dev.off()
png("figure/scatter_giniIB.png", width=12/2.54*ppi, height=8/2.54*ppi, res=ppi)
plot2
dev.off()
```
