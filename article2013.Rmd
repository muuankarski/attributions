...
The study utilizes the data from the second wave of Life in Transition Survey[^***2] (LiTS2), conducted by European Bank of Development and Reconstruction (EBRD) and  World Bank in 2010. The analyses cover 22 post-socialist countries and 5 Western European countries. The survey was collected using a two-stage clustered stratified sampling procedure to select the households that were included in the sample (for more detailed description of sampling and data collection, see EBRD 2011). The survey had a special focus on how people’s lives were affected by the global economic crises and its aftermath.
