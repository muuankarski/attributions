...
opts_chunk$set(echo=TRUE,eval=FALSE, cache=TRUE,message=FALSE,warning=FALSE,fig.width=12,fig.height=10)
```
...
```{rmultilevelBivarSocOutputNOCI, results='asis', eval=TRUE}
...
```{rmultilevelBivarIndOuputNOCI, results='asis', eval=TRUE}
library(texreg)
...
```{rmultilevelMultiSocOutputNOCI, results='asis', eval=TRUE}
coef.names.multi = c("(intercept)", 
                      "Dependent","Low education",
                      "Low income","Income has worsened",
                      "Income will worsen","Has affected great or fair amount",
...
```{rmultilevelMultiIndOutputNOCI, results='asis', eval=TRUE}
htmlreg(list(ind.0,
       ind.1,
       ind.2,
       ind.3,
...
```{rmultilevelMultivarFull, eval=TRUE}
...
```{rmultilevelMultivarSlideOutput, results='asis', eval=TRUE, eval=TRUE}
library(texreg)
coef.names.multi = c("(intercept)", 
                      "Dependent","Low education",
                      "Low income","Income has worsened",
