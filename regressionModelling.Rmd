...
summary(bisoc.1 <- glmer(pov.log.social ~ incsour3+(1|cntry),
                        family = binomial(logit), data=df))
summary(bisoc.2 <- glmer(pov.log.social ~ edu2+(1|cntry),
                        family = binomial(logit), data=df))
summary(bisoc.3 <- glmer(pov.log.social ~ income2+(1|cntry),
                        family = binomial(logit), data=df))
summary(bisoc.4 <- glmer(pov.log.social ~ past.diff+(1|cntry),
                        family = binomial(logit), data=df))
summary(bisoc.5 <- glmer(pov.log.social ~ future.diff+(1|cntry),
                        family = binomial(logit), data=df))
summary(bisoc.6 <- glmer(pov.log.social ~ crise+(1|cntry),
                        family = binomial(logit), data=df))
summary(bisoc.7 <- glmer(pov.log.social ~ group1+(1|cntry),
                        family = binomial(logit), data=df))
summary(bisoc.8 <- glmer(pov.log.social ~ uw.gini+(1|cntry),
                        family = binomial(logit), data=df))
summary(bisoc.9 <- glmer(pov.log.social ~ gdpchange07.10+(1|cntry),
                        family = binomial(logit), data=df))
summary(bisoc.10 <- glmer(pov.log.social ~ wbgi.vae+(1|cntry),
                         family = binomial(logit), data=df))
